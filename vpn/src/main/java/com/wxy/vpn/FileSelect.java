...
import com.wxy.vpn.fragments.FileSelectionFragment;
import com.wxy.vpn.fragments.InlineFileTab;
...
public class FileSelect extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(com.wxy.vpn.R.layout.file_dialog);
		...
		fileExplorerTab = bar.newTab().setText(de.blinkt.openvpn.R.string.file_explorer_tab);
		inlineFileTab = bar.newTab().setText(de.blinkt.openvpn.R.string.inline_file_tab);
	...
	public void importFile(String path) {
		...
		if(fe!=null) {
			...
			ab.setTitle(de.blinkt.openvpn.R.string.error_importing_file);
			ab.setMessage(getString(de.blinkt.openvpn.R.string.import_error_message) + "\n" + fe.getLocalizedMessage());
