...
public class Connection implements Serializable, Cloneable {
    ...
    @Override
    public de.blinkt.openvpn.core.Connection clone() throws CloneNotSupportedException {
        return (de.blinkt.openvpn.core.Connection) super.clone();
    }
